...
- (void)configBtns
{
    ...
    height1=is4_inch?38.5:16.5;
    height2=is4_inch?176:133;
    height3=is4_inch?314.5:249.5;
    
    [self createBtns:_weaponBtn withFrame:CGRectMake(-screenWidth, height1, screenWidth, 100) angImage:@"weaponimg" Tag:300];
    [self createBtns:_jewelryBtn withFrame:CGRectMake(screenWidth, height2, screenWidth, 100) angImage:@"jewelryimg" Tag:301];
    [self createBtns:_baguaBtn withFrame:CGRectMake(-screenWidth, height3, screenWidth, 100) angImage:@"baguaimg" Tag:302];
    
}

- (void)createBtns:(UIButton *)button withFrame:(CGRect)frame angImage:(NSString *)imgName Tag:(NSInteger)tag
{
    ...
    [UIView animateWithDuration:1.2 delay:0.1 options:UIViewAnimationOptionCurveEaseInOut animations:^{
